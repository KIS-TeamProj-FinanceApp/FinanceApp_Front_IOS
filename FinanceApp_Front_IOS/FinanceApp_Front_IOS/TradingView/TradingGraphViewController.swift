//
//  TradingGraphViewController.swift
...
struct TradingGraphViewController: View {
...
struct TradingGraphViewController_Previews: PreviewProvider {
    static var previews: some View {
        TradingGraphViewController()
    }
}
