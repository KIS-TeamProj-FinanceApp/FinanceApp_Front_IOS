...
struct MyAccountSecuritiesDto: Decodable {
    // 종목명 prdt_name
    // 종목코드 pdno
    //평가손익 evlu_pfls_amt
    ...
    enum CodingKeys: String, CodingKey{
        ...
        case pdno = "pdno"
        case evlu_pfls_amt = "evlu_pfls_amt"
        case evlu_pfls_rt = "evlu_pfls_rt"
        case evlu_amt = "evlu_amt"
        case hldg_qty = "hldg_qty"
        case pchs_amt = "pchs_amt"
        case pchs_avg_pric = "pchs_avg_pric"
        case prpr = "prpr"
        case fltt_rt = "fltt_rt"
        case thdt_buyqty = "thdt_buyqty"
        case thdt_sll_qty = "thdt_sll_qty"
    }
}
